...
DROP POLICY IF EXISTS floor_plan_rooms_select ON floor_plan_rooms;
DROP POLICY IF EXISTS floor_plan_rooms_insert ON floor_plan_rooms;
DROP POLICY IF EXISTS floor_plan_rooms_update ON floor_plan_rooms;
DROP POLICY IF EXISTS floor_plan_rooms_delete ON floor_plan_rooms;
...
DROP POLICY IF EXISTS floor_plan_versions_select ON floor_plan_versions;
DROP POLICY IF EXISTS floor_plan_versions_insert ON floor_plan_versions;
DROP POLICY IF EXISTS floor_plan_versions_update ON floor_plan_versions;
DROP POLICY IF EXISTS floor_plan_versions_delete ON floor_plan_versions;
...
DROP POLICY IF EXISTS floor_plan_templates_v2_select ON floor_plan_templates_v2;
DROP POLICY IF EXISTS floor_plan_templates_v2_insert ON floor_plan_templates_v2;
DROP POLICY IF EXISTS floor_plan_templates_v2_update ON floor_plan_templates_v2;
DROP POLICY IF EXISTS floor_plan_templates_v2_delete ON floor_plan_templates_v2;
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'fk_floor_plan_rooms_current_version'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'fk_floor_plan_rooms_draft_version'
  ) THEN
    ALTER TABLE floor_plan_rooms
