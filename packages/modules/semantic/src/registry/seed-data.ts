...
export const GOLF_METRICS: Omit<MetricDef, 'isActive' | 'isExperimental'>[] = [
  ...
  },
  {
    ...
    domain: 'golf',
    category: 'operations',
    sqlExpression: 'AVG(avg_round_duration_min)',
...
export const SPA_DIMENSIONS: Omit<DimensionDef, 'isActive'>[] = [
  ...
  {
    slug: 'spa_provider',
    displayName: 'Spa Provider',
    description: 'Spa therapist / provider / stylist',
    domain: 'spa',
    category: 'operation',
    sqlExpression: 'provider_id',
    sqlTable: 'rm_spa_provider_metrics',
    sqlDataType: 'text',
    isTimeDimension: false,
    lookupTable: 'spa_providers',
    lookupKeyColumn: 'id',
    lookupLabelColumn: 'display_name',
    aliases: ['therapist', 'provider', 'stylist', 'spa staff', 'esthetician'],
    examplePhrases: ['by provider', 'by therapist', 'which provider', 'per therapist'],
  },
  {
    slug: 'spa_service',
    displayName: 'Spa Service',
    description: 'Spa service / treatment type',
    domain: 'spa',
    category: 'product',
    sqlExpression: 'service_id',
    sqlTable: 'rm_spa_service_metrics',
    sqlDataType: 'text',
    isTimeDimension: false,
    lookupTable: 'spa_services',
    lookupKeyColumn: 'id',
    lookupLabelColumn: 'name',
    aliases: ['service', 'treatment', 'spa treatment', 'service type'],
    examplePhrases: ['by service', 'by treatment', 'which service', 'per treatment'],
  },
];
...
export const SPA_METRICS: Omit<MetricDef, 'isActive' | 'isExperimental'>[] = [
  ...
  {
    slug: 'spa_provider_revenue',
    displayName: 'Provider Revenue',
    description: 'Revenue per spa provider in dollars. Pre-aggregated daily per provider from rm_spa_provider_metrics.',
    domain: 'spa',
    category: 'revenue',
    sqlExpression: 'SUM(total_revenue)',
    sqlTable: 'rm_spa_provider_metrics',
    ...
    unit: 'USD',
    higherIsBetter: true,
    aliases: ['provider revenue', 'therapist revenue', 'provider sales'],
    examplePhrases: ['revenue by provider', 'top earning therapist', 'provider revenue this week'],
    relatedMetrics: ['spa_provider_commissions', 'spa_provider_tips', 'spa_provider_appointments'],
  },
  {
    slug: 'spa_provider_commissions',
    displayName: 'Provider Commissions',
    description: 'Commissions earned per provider in dollars. Pre-aggregated daily per provider.',
    domain: 'spa',
    category: 'revenue',
    sqlExpression: 'SUM(commission_total)',
    sqlTable: 'rm_spa_provider_metrics',
    sqlAggregation: 'sum',
    dataType: 'currency',
    formatPattern: '$0,0.00',
    unit: 'USD',
    higherIsBetter: null,
    aliases: ['provider commissions', 'therapist commissions', 'commission earned'],
    examplePhrases: ['commissions by provider', 'how much in commissions', 'provider commissions this month'],
    relatedMetrics: ['spa_provider_revenue', 'spa_provider_tips'],
  },
  {
    slug: 'spa_provider_tips',
    displayName: 'Provider Tips',
    description: 'Tips earned per provider in dollars. Pre-aggregated daily per provider.',
    domain: 'spa',
    category: 'revenue',
    sqlExpression: 'SUM(tip_total)',
    sqlTable: 'rm_spa_provider_metrics',
    ...
    unit: 'USD',
    higherIsBetter: true,
    aliases: ['provider tips', 'therapist tips', 'tips by provider'],
    examplePhrases: ['tips by provider', 'who got the most tips', 'provider tips this week'],
    relatedMetrics: ['spa_provider_revenue', 'spa_provider_commissions'],
  },
  {
    slug: 'spa_provider_appointments',
    displayName: 'Provider Appointments',
    description: 'Appointment count per provider. Pre-aggregated daily per provider.',
    domain: 'spa',
    category: 'volume',
    sqlExpression: 'SUM(appointment_count)',
    sqlTable: 'rm_spa_provider_metrics',
    ...
    unit: 'appointments',
    higherIsBetter: true,
    aliases: ['provider appointments', 'therapist bookings', 'appointments per provider'],
    examplePhrases: ['appointments by provider', 'busiest therapist', 'provider appointment count'],
    relatedMetrics: ['spa_provider_revenue', 'spa_provider_utilization'],
  },
  {
    slug: 'spa_provider_utilization',
    displayName: 'Provider Utilization %',
    description: 'Provider utilization percentage. Pre-aggregated daily per provider.',
    domain: 'spa',
    category: 'efficiency',
    sqlExpression: 'SUM(utilization_pct * completed_count)::NUMERIC / NULLIF(SUM(completed_count), 0)',
    sqlTable: 'rm_spa_provider_metrics',
    ...
    unit: '%',
    higherIsBetter: true,
    aliases: ['provider utilization', 'therapist utilization', 'provider busy rate'],
    examplePhrases: ['provider utilization', 'busiest provider', 'therapist utilization rate'],
    relatedMetrics: ['spa_provider_appointments', 'spa_provider_revenue'],
  },
  {
    slug: 'spa_provider_client_count',
    displayName: 'Provider Client Count',
    description: 'Distinct clients seen per provider. Pre-aggregated daily per provider.',
    domain: 'spa',
    category: 'volume',
    sqlExpression: 'SUM(client_count)',
    sqlTable: 'rm_spa_provider_metrics',
    sqlAggregation: 'sum',
    dataType: 'integer',
    formatPattern: '0,0',
    unit: 'clients',
    higherIsBetter: true,
    aliases: ['provider clients', 'therapist client count', 'clients per provider'],
    examplePhrases: ['clients by provider', 'how many clients per therapist', 'provider client count'],
    relatedMetrics: ['spa_provider_appointments', 'spa_provider_new_clients'],
  },
  {
    slug: 'spa_provider_new_clients',
    displayName: 'Provider New Clients',
    description: 'New clients seen per provider. Pre-aggregated daily per provider.',
    domain: 'spa',
    category: 'volume',
    sqlExpression: 'SUM(new_client_count)',
    sqlTable: 'rm_spa_provider_metrics',
    sqlAggregation: 'sum',
    dataType: 'integer',
    formatPattern: '0,0',
    unit: 'clients',
    higherIsBetter: true,
    aliases: ['new clients', 'new spa clients', 'new clients per provider'],
    examplePhrases: ['new clients by provider', 'how many new clients', 'new spa clients this week'],
    relatedMetrics: ['spa_provider_client_count', 'spa_provider_appointments'],
  },

  // ── rm_spa_service_metrics ──────────────────────────────────────
  {
    slug: 'spa_service_bookings',
    displayName: 'Service Bookings',
    description: 'Booking count per spa service. Pre-aggregated daily per service from rm_spa_service_metrics.',
    domain: 'spa',
    category: 'volume',
    sqlExpression: 'SUM(booking_count)',
    sqlTable: 'rm_spa_service_metrics',
    sqlAggregation: 'sum',
    dataType: 'integer',
    formatPattern: '0,0',
    unit: 'bookings',
    higherIsBetter: true,
    aliases: ['service bookings', 'treatment bookings', 'bookings by service'],
    examplePhrases: ['bookings by service', 'most popular service', 'top booked treatment'],
    relatedMetrics: ['spa_service_revenue', 'spa_service_completed'],
  },
  {
    slug: 'spa_service_completed',
    displayName: 'Service Completions',
    description: 'Completed booking count per spa service. Pre-aggregated daily per service.',
    domain: 'spa',
    category: 'volume',
    sqlExpression: 'SUM(completed_count)',
    sqlTable: 'rm_spa_service_metrics',
    ...
    unit: 'completions',
    higherIsBetter: true,
    aliases: ['service completions', 'completed treatments', 'treatments done'],
    examplePhrases: ['completed by service', 'how many massages completed', 'service completions this week'],
    relatedMetrics: ['spa_service_bookings', 'spa_service_revenue'],
  },
  {
    slug: 'spa_per_service_revenue',
    displayName: 'Revenue by Service',
    description: 'Revenue per individual spa service in dollars. Pre-aggregated daily per service from rm_spa_service_metrics. Use this to compare revenue across different services/treatments.',
    domain: 'spa',
    category: 'revenue',
    sqlExpression: 'SUM(total_revenue)',
    sqlTable: 'rm_spa_service_metrics',
    ...
    unit: 'USD',
    higherIsBetter: true,
    aliases: ['service revenue breakdown', 'revenue by treatment', 'treatment revenue', 'per service revenue'],
    examplePhrases: ['revenue by service', 'top revenue service', 'massage revenue this month'],
    relatedMetrics: ['spa_service_bookings', 'spa_service_addon_rate'],
  },
  {
    slug: 'spa_service_addon_rate',
    displayName: 'Add-On Attachment Rate',
    description: 'Percentage of bookings that included add-ons, per service. Pre-aggregated daily.',
    domain: 'spa',
    category: 'efficiency',
    sqlExpression: 'SUM(addon_attachment_rate * booking_count)::NUMERIC / NULLIF(SUM(booking_count), 0)',
    sqlTable: 'rm_spa_service_metrics',
    sqlAggregation: 'custom',
    dataType: 'percent',
    formatPattern: '0.0%',
    unit: '%',
    higherIsBetter: true,
    aliases: ['addon rate', 'upsell rate', 'add-on attachment', 'addon attachment rate'],
    examplePhrases: ['addon attachment rate by service', 'which service has best upsell', 'add-on rate'],
    relatedMetrics: ['spa_service_bookings', 'spa_service_revenue'],
  },
];
...
export const SPA_METRIC_DIMENSIONS: MetricDimensionRelation[] = [
  // ── rm_spa_daily_operations metrics (date + spa_location) ──────
  ...
  // ── rm_spa_provider_metrics (date + spa_provider) ──────────────
  // spa_provider_revenue
  { metricSlug: 'spa_provider_revenue', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_provider_revenue', dimensionSlug: 'spa_provider', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_provider_commissions
  { metricSlug: 'spa_provider_commissions', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_provider_commissions', dimensionSlug: 'spa_provider', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_provider_tips
  { metricSlug: 'spa_provider_tips', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_provider_tips', dimensionSlug: 'spa_provider', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_provider_appointments
  { metricSlug: 'spa_provider_appointments', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_provider_appointments', dimensionSlug: 'spa_provider', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_provider_utilization (date REQUIRED)
  { metricSlug: 'spa_provider_utilization', dimensionSlug: 'date', isRequired: true, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_provider_utilization', dimensionSlug: 'spa_provider', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_provider_client_count
  { metricSlug: 'spa_provider_client_count', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_provider_client_count', dimensionSlug: 'spa_provider', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_provider_new_clients
  { metricSlug: 'spa_provider_new_clients', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_provider_new_clients', dimensionSlug: 'spa_provider', isRequired: false, isDefault: true, sortOrder: 1 },

  // ── rm_spa_service_metrics (date + spa_service) ────────────────
  // spa_service_bookings
  { metricSlug: 'spa_service_bookings', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_service_bookings', dimensionSlug: 'spa_service', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_service_completed
  { metricSlug: 'spa_service_completed', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_service_completed', dimensionSlug: 'spa_service', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_service_revenue
  { metricSlug: 'spa_per_service_revenue', dimensionSlug: 'date', isRequired: false, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_per_service_revenue', dimensionSlug: 'spa_service', isRequired: false, isDefault: true, sortOrder: 1 },
  // spa_service_addon_rate (date REQUIRED)
  { metricSlug: 'spa_service_addon_rate', dimensionSlug: 'date', isRequired: true, isDefault: true, sortOrder: 0 },
  { metricSlug: 'spa_service_addon_rate', dimensionSlug: 'spa_service', isRequired: false, isDefault: true, sortOrder: 1 },
];
...
export const SPA_SYSTEM_LENSES: Omit<LensDef, 'isActive'>[] = [
  ...
  {
    slug: 'spa_providers',
    displayName: 'Spa Provider Performance',
    description: 'Therapist/provider performance: appointments, revenue, commissions, tips, utilization, client counts',
    domain: 'spa',
    isSystem: true,
    allowedMetrics: [
      'spa_provider_revenue', 'spa_provider_commissions', 'spa_provider_tips',
      'spa_provider_appointments', 'spa_provider_utilization',
      'spa_provider_client_count', 'spa_provider_new_clients',
    ],
    allowedDimensions: ['date', 'spa_provider', 'week', 'month'],
    defaultMetrics: ['spa_provider_revenue', 'spa_provider_appointments'],
    defaultDimensions: ['date', 'spa_provider'],
    exampleQuestions: [
      'Revenue by provider this week?',
      'Who is our top earning therapist?',
      'Provider commissions this month?',
      'Which provider has the most clients?',
      'Provider utilization rates?',
    ],
    systemPromptFragment:
      'You are analyzing spa provider performance. Metrics come from rm_spa_provider_metrics (pre-aggregated per provider per day). spa_provider_revenue = total revenue, spa_provider_commissions = earned commissions, spa_provider_tips = tips. spa_provider_utilization is a percentage — always include date dimension. Use spa_provider dimension to break down by therapist.',
  },
  {
    slug: 'spa_services_analytics',
    displayName: 'Spa Service Analytics',
    description: 'Service popularity, revenue by treatment type, add-on attachment rates',
    domain: 'spa',
    isSystem: true,
    allowedMetrics: [
      'spa_service_bookings', 'spa_service_completed', 'spa_per_service_revenue',
      'spa_service_addon_rate',
    ],
    allowedDimensions: ['date', 'spa_service', 'week', 'month'],
    defaultMetrics: ['spa_service_bookings', 'spa_per_service_revenue'],
    defaultDimensions: ['date', 'spa_service'],
    exampleQuestions: [
      'Most popular spa service this month?',
      'Revenue by treatment type?',
      'Which service has the best add-on attachment rate?',
      'Service booking trends?',
    ],
    systemPromptFragment:
      'You are analyzing spa service performance. Metrics come from rm_spa_service_metrics (pre-aggregated per service per day). spa_service_bookings = booking volume, spa_per_service_revenue = revenue per service, spa_service_addon_rate = add-on upsell rate. Use spa_service dimension to compare treatments.',
  },
];
