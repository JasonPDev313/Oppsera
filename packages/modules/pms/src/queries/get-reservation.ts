  ...
  return withTenant(tenantId, async (tx) => {
    const [row] = await tx
      .select({
        ...
        specialRequests: pmsReservations.specialRequests,
        eta: pmsReservations.eta,
        doNotMove: pmsReservations.doNotMove,
        marketSegment: pmsReservations.marketSegment,
        vehicleJson: pmsReservations.vehicleJson,
        ...
        // Joined — Guest (expanded)
        guestFirstName: pmsGuests.firstName,
        guestLastName: pmsGuests.lastName,
        guestEmail: pmsGuests.email,
        guestPhone: pmsGuests.phone,
        guestCustomerId: pmsGuests.customerId,
        guestAddressJson: pmsGuests.addressJson,
        guestIsVip: pmsGuests.isVip,
        guestTotalStays: pmsGuests.totalStays,
        guestPreferencesJson: pmsGuests.preferencesJson,
        guestNotes2: pmsGuests.notes,
        // Joined — Folio
