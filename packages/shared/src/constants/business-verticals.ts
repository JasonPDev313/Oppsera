...
export const BUSINESS_VERTICALS: readonly BusinessVertical[] = [
  ...
  // ── HOSPITALITY ───────────────────────────────────────────────
  { key: 'hotel',           name: 'Hotel / Resort',       icon: 'Hotel',           description: 'Front desk, reservations, housekeeping',  status: 'available',   category: 'hospitality',     defaultTier: 'MID_MARKET', recommendedModules: ['catalog', 'orders', 'pos_retail', 'pos_fnb', 'payments', 'inventory', 'customers', 'reporting', 'accounting', 'pms', 'semantic', 'room_layouts'] },
  ...
  // ── HEALTH & WELLNESS ─────────────────────────────────────────
  { key: 'salon',           name: 'Salon / Barbershop',       icon: 'Scissors',    description: 'Appointments, POS, client management',  status: 'coming_soon', category: 'health_wellness', defaultTier: 'SMB', recommendedModules: ['catalog', 'pos_retail', 'payments', 'customers', 'reporting', 'spa'] },
  { key: 'spa',             name: 'Spa / Wellness Center',    icon: 'Sparkles',    description: 'Services, packages, memberships',        status: 'available',   category: 'health_wellness', defaultTier: 'SMB', recommendedModules: ['catalog', 'pos_retail', 'payments', 'customers', 'reporting', 'club_membership', 'spa'] },
