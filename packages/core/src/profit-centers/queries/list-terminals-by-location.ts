...
interface ListTerminalsByLocationInput {
  tenantId: string;
  locationId: string;
...
/**
 * List all terminals at a location, across all profit centers.
 * Used by Simple mode where profit centers are hidden.
 */
export async function listTerminalsByLocation(
  input: ListTerminalsByLocationInput,
