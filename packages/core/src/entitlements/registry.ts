...
export const MODULE_REGISTRY: readonly ModuleDefinition[] = [
  ...
  },
  {
    ...
    name: 'Orders',
    phase: 'v1',
    description: 'Order lifecycle, line items, discounts, tax calculation',
  ...
  },
  {
    ...
    name: 'Retail POS',
    phase: 'v1',
    description: 'Retail POS shell, barcode scanning, hold/recall',
    dependencies: ['catalog', 'payments', 'orders'],
    riskLevel: 'high',
    supportsViewMode: true,
    category: 'commerce',
  },
  ...
  },
  {
    ...
    phase: 'v1',
    description: 'Expense reports, policies, approvals, receipts, reimbursements, mileage, per-diem',
    dependencies: ['accounting'],
    riskLevel: 'medium',
    supportsViewMode: true,
    category: 'finance',
  },
  {
    ...
    phase: 'v1',
    description: 'Projects, tasks, cost allocation, profitability analysis, budget tracking',
    dependencies: ['accounting'],
    riskLevel: 'medium',
    supportsViewMode: true,
    category: 'finance',
