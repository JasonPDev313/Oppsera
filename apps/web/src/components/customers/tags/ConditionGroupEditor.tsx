  ...
  return (
    <div className="space-y-3">
        ...
        <div key={groupIdx}>
          ...
          {groupIdx > 0 && (
            <div className="flex items-center gap-3 py-2">
              ...
              <span className="shrink-0 rounded-full bg-indigo-100 px-3 py-0.5 text-xs font-semibold uppercase text-indigo-700">
                OR
              </span>
              <div className="flex-1 border-t border-gray-200" />
            </div>
          ...
          {/* Group card */}
          <div className="relative rounded-lg border border-gray-200 bg-surface p-4">
            {/* Remove group button */}
            <button
              type="button"
              onClick={() => handleRemoveGroup(groupIdx)}
              disabled={groups.length <= 1}
              className="absolute right-2 top-2 rounded-lg p-1 text-gray-400 transition-colors hover:bg-red-500/10 hover:text-red-500 disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-gray-400"
              title="Remove group"
            >
              <X className="h-4 w-4" />
            </button>
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg border border-dashed border-gray-300 px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:border-indigo-400 hover:text-indigo-600 hover:bg-indigo-500/5"
      >
