...
export default function CalendarStatsBar({ totalRooms, occupancy, lastUpdatedAt }: CalendarStatsBarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-5 gap-y-1.5 rounded-lg border border-gray-200 bg-surface px-4 py-2">
      ...
      <div className="flex items-center gap-1.5">
        <span className="text-[10px] uppercase tracking-wider text-gray-400">Occ%</span>
