    ...
    <div className={`overflow-hidden rounded-lg border border-border bg-surface ${className}`}>
      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="w-full">
          ...
          <tfoot>
            <tr className="border-t border-input bg-muted font-semibold">
            ...
            {!isBalanced && (
              <tr className="bg-red-500/10">
                <td colSpan={3} className="px-4 py-2 text-sm font-medium text-red-500">
                  Difference
                </td>
                <td colSpan={2} className="px-4 py-2 text-right text-sm font-medium tabular-nums text-red-500">
      ...
      <div className="space-y-3 p-4 md:hidden">
        {lines.map((line, i) => (
          <div key={line.id ?? i} className="rounded-lg border border-border p-3 space-y-1">
            ...
            {line.memo && (
              <div className="text-xs text-muted-foreground">{line.memo}</div>
            )}
        ...
        {/* Totals */}
        <div className="rounded-lg border border-input bg-muted p-3 space-y-1">
