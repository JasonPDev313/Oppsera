          ...
          <div>
            ...
            {!['Square', 'Stripe', 'Clover', 'Toast', 'Heartland', 'Elavon', 'First Data', 'WorldPay'].includes(processorName) && (
              <input
                ...
                className="w-full mt-2 rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-indigo-500"
              />
            )}
          </div>
          ...
          <div>
            ...
            <details className="mt-2">
              ...
              <textarea
                ...
                className="w-full mt-2 rounded-md border border-gray-300 px-3 py-2 text-xs font-mono focus:border-indigo-500 focus:ring-indigo-500"
              />
            </details>
          </div>
