    ...
    <div className="flex h-full flex-col">
      ...
      <div className="shrink-0 border-b border-border px-4 py-2">
        <input
          ...
          className="w-full rounded-md border border-border px-2 py-1.5 text-xs text-foreground placeholder:text-muted-foreground focus:border-indigo-500 focus:outline-none"
        />
        {employeeFilter && (
          <button
            type="button"
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Loading tabs...</p>
          </div>
        ) : filteredTabs.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16">
            <Inbox className="h-10 w-10 text-muted-foreground" />
            <p className="mt-3 text-sm text-muted-foreground">No transferable tabs</p>
