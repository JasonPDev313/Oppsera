  ...
  if (error || !data) {
    return (
      <div className="p-6 text-center">
        <p className="text-sm text-red-500">Failed to load identity data.</p>
        <button
          type="button"
          onClick={fetchData}
            ...
            {identifiers.map((id) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">{id.value}</p>
        ...
        <section>
          ...
          <div className="space-y-2">
            {externalIds.map((ext) => (
              ...
              >
                <div>
                  <p className="text-sm font-medium text-foreground">{ext.provider}</p>
                  <p className="text-xs text-muted-foreground font-mono">{ext.externalId}</p>
                </div>
                <p className="text-xs text-muted-foreground">{formatDate(ext.createdAt)}</p>
              </div>
            ))}
          </div>
        </section>
