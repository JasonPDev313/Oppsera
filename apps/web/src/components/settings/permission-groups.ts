...
export const PERMISSION_GROUPS: PermissionGroupEntry[] = [
  ...
  // ── Accounting ────────────────────────────────────────────
  {
    ...
    subGroups: [
      ...
      { label: 'Expenses', permissions: ['expenses.view', 'expenses.create', 'expenses.approve', 'expenses.manage'] },
      { label: 'Project Costing', permissions: ['project_costing.view', 'project_costing.manage'] },
    ],
  },
  // ── AP / AR ─────────────────────────────────────────────────
  ...
  // ── F&B POS ───────────────────────────────────────────────
  {
    ...
    subGroups: [
      ...
      { label: 'Tabs', permissions: ['pos_fnb.tabs.view', 'pos_fnb.tabs.create', 'pos_fnb.tabs.transfer', 'pos_fnb.tabs.void', 'pos_fnb.tabs.manage', 'pos_fnb.tabs.manage_bulk_all_servers'] },
      ...
      { label: 'Inventory', permissions: ['pos_fnb.inventory.view', 'pos_fnb.inventory.manage'] },
      { label: 'Host Stand', permissions: ['pos_fnb.host.view', 'pos_fnb.host.manage', 'pos_fnb.host.notifications', 'pos_fnb.host.analytics'] },
    ],
  },
  // ── Kitchen Display ───────────────────────────────────────
  { label: 'Kitchen Display', permissions: ['kds.view', 'kds.bump', 'kds.hold', 'kds.fire_course', 'kds.recall', 'kds.manage', 'kds.settings.manage'] },
  // ── AI Insights ───────────────────────────────────────────
...
export const CATEGORY_TABS: CategoryTab[] = [
  ...
  { key: 'fnb', label: 'F&B', groupLabels: ['F&B POS', 'Kitchen Display'] },
  ...
  { key: 'reports', label: 'Reports & AI', groupLabels: ['Reports', 'AI Insights'] },
