  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg rounded-lg bg-surface p-6 shadow-xl">
        <h3 className="text-lg font-semibold text-gray-900">Edit Room Details</h3>
        <p className="mt-1 text-sm text-gray-500">Update the room name, dimensions, or description.</p>
