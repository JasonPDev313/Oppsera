...
import { completePaymentSession, completePaymentSessionSchema } from '@oppsera/module-fnb';

// POST /api/v1/fnb/payments/sessions/[id]/complete — complete payment session
