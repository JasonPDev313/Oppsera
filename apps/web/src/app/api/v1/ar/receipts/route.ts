...
import { listReceipts, createReceipt, createReceiptSchema } from '@oppsera/module-ar';
...
// POST /api/v1/ar/receipts — create a receipt
export const POST = withMiddleware(
  async (request: NextRequest, ctx) => {
    ...
    // Map validation schema to command input shape
