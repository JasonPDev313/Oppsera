...
const FEATURES = [
  {
    ...
    description: 'Embeddable booking widget for your website and social media',
    icon: Globe,
  },
  {
    title: 'Deposit Collection',
    description: 'Require deposits or full payment at time of booking',
    icon: CreditCard,
  },
  {
    title: 'Email Confirmations',
    description: 'Automated confirmation and reminder emails for clients',
    icon: Mail,
  },
  {
    title: 'Calendar Sync',
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Configure and manage online spa booking portal
        </p>
      </div>
