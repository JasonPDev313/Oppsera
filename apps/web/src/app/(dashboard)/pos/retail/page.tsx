        ...
        <div className="flex w-[40%] flex-col bg-white">
          ...
          <div className="shrink-0 px-4 py-2">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-indigo-600 px-4 py-3 text-base font-semibold text-white transition-colors hover:bg-indigo-700 disabled:cursor-not-allowed disabled:bg-indigo-300"
            >
              {pos.isLoading ? (
          ...
          <div className="shrink-0 border-t border-gray-100 px-4 py-2">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-red-200 px-2 py-2 text-sm font-medium text-red-600 transition-colors hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-40"
              >
