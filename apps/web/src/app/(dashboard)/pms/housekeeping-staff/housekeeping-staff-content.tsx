    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage housekeepers assigned to your properties.</p>
        </div>
              ...
              <div className="absolute right-0 mt-1 w-56 rounded-md bg-surface border border-border shadow-lg z-10">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Choose from current users</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Add a new user as housekeeper</div>
                  </div>
                </button>
              </div>
            )}
                ...
                <tr key={hk.id} className="border-b border-border last:border-0">
                  <td className="px-4 py-3">
                    ...
                    {hk.userDisplayName && hk.userDisplayName !== hk.name && (
                      <div className="text-xs text-muted-foreground">{hk.userDisplayName}</div>
                    )}
                  </td>
                  <td className="px-4 py-3 text-muted-foreground">{hk.userEmail}</td>
                  <td className="px-4 py-3 text-muted-foreground hidden md:table-cell">{hk.phone ?? '—'}</td>
                  <td className="px-4 py-3">
                    {hk.isActive ? (
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-500/10 text-muted-foreground border border-gray-500/30">
                        Inactive
                      </span>
                    )}
                  </td>
