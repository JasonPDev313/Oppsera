  ...
  if (!locationId) {
    return (
      <div className="flex items-center justify-center min-h-[60vh] p-6 text-center">
        <p className="text-sm text-gray-500">Invalid link. Please scan the QR code again.</p>
      </div>
    );
  }
  ...
  return (
    <div className="pb-8">
      ...
      <div className="text-center pt-6 px-6 mb-6">
        ...
        <h1 className="text-xl font-bold text-gray-800">Join the Waitlist</h1>
        {estimate && (
      ...
      <div className="px-6 space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm text-gray-800 placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400"
          />
        </div>
        ...
        <div>
          ...
          {showCustom && (
            <input
              ...
              min={8}
              max={99}
              className="mt-2 w-full rounded-xl border border-gray-200 px-4 py-3 text-sm text-gray-800 placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400"
            />
          )}
        </div>
        ...
        <div>
          <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5 block">
            Seating Preference <span className="text-gray-300 normal-case">(optional)</span>
          </label>
          <div className="flex flex-wrap gap-2">
