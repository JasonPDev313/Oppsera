 ...
 * then maps all 41 system transaction types with PwC-standard debit/credit assignments.
 *
...
const REQUIRED_ACCOUNTS: AccountDef[] = [
  ...
  { number: '4100', name: 'Discounts Given',            type: 'revenue',   normalBalance: 'credit', classification: 'Discounts & Returns',     isControlAccount: false, controlAccountType: null,              sortOrder: 490 },
  { number: '4110', name: 'Returns & Allowances',       type: 'revenue',   normalBalance: 'credit', classification: 'Discounts & Returns',     isControlAccount: false, controlAccountType: null,              sortOrder: 491 },
  { number: '4500', name: 'Service Charge Revenue',     type: 'revenue',   normalBalance: 'credit', classification: 'Operating Revenue',       isControlAccount: false, controlAccountType: null,              sortOrder: 495 },
  { number: '4510', name: 'Surcharge Revenue',          type: 'revenue',   normalBalance: 'credit', classification: 'Operating Revenue',       isControlAccount: false, controlAccountType: null,              sortOrder: 496 },
  ...
  { number: '5010', name: 'Pro Shop COGS',              type: 'expense',   normalBalance: 'debit',  classification: 'Cost of Goods Sold',      isControlAccount: false, controlAccountType: null,              sortOrder: 500 },
  { number: '5020', name: 'F&B COGS',                   type: 'expense',   normalBalance: 'debit',  classification: 'Cost of Goods Sold',      isControlAccount: false, controlAccountType: null,              sortOrder: 510 },
  ...
  { number: '6150', name: 'Comp Expense',               type: 'expense',   normalBalance: 'debit',  classification: 'Operating Expenses',      isControlAccount: false, controlAccountType: null,              sortOrder: 695 },
  { number: '6160', name: 'Cash Over/Short',            type: 'expense',   normalBalance: 'debit',  classification: 'Operating Expenses',      isControlAccount: false, controlAccountType: null,              sortOrder: 696 },
  { number: '6170', name: 'Chargeback Expense',         type: 'expense',   normalBalance: 'debit',  classification: 'Operating Expenses',      isControlAccount: false, controlAccountType: null,              sortOrder: 697 },
