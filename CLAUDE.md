...
> Full top 30: [docs/conventions/gotchas-top30.md](docs/conventions/gotchas-top30.md) | All 588: [docs/conventions/gotchas-reference.md](docs/conventions/gotchas-reference.md)
...
| [docs/conventions/gotchas-reference.md](docs/conventions/gotchas-reference.md) | All 588 gotchas |
| [docs/conventions/whats-built.md](docs/conventions/whats-built.md) | Complete module/feature inventory |
| [docs/conventions/CONVENTIONS_FULL.md](docs/conventions/CONVENTIONS_FULL.md) | Full dev conventions (280 sections) |
